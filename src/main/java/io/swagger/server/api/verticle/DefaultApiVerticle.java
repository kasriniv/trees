...
public class DefaultApiVerticle extends AbstractVerticle {
    ...
    final static String GET_TREES_SERVICE_ID = "GET_trees";
    ...
    public void start() throws Exception {
        ...
        //Consumer for GET_trees
        vertx.eventBus().<JsonObject> consumer(GET_TREES_SERVICE_ID).handler(message -> {
            try {
                
                Trees result = service.treesGet();
